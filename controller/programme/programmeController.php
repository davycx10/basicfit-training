<!-- // controller/programme/programmeController.php
// Gère les actions liées aux programmes (ajout, modification, suppression) -->
...
if (isset($_POST['action'])) {
    ...
    switch ($_POST['action']) {
        ...
        default:
            header('Location: index.php?page=programme'); // adapté selon la structure
            exit;
    }
}
