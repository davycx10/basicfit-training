<section class="form-section" style="background-color: #eee;">
    <div class="form-card" style="max-width: 600px; border-top: 5px solid #333;">
        ...
        <!-- IMPORTANT : enctype pour upload PDF -->
        <form action="controller/coach/candidatController.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" class="form-input" placeholder="Entrez votre email professionnel" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="experience" class="form-input" placeholder="Nombre d'années d'expérience" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="linkedin" class="form-input" placeholder="Lien de votre profil" required>
            </div>

            <div class="form-group">
                <label>Mot de passe :</label>
                <input type="password" name="password" class="form-input" placeholder="Entrez un mot de passe" required>
            </div>

            <button type="submit" class="btn btn-primary full-width" style="background-color: #333; border-color: #333;">
                Envoyer ma candidature
            </button>
        </form>

        <div class="form-footer">
            <p>Déjà membre de l'équipe ? 
                <a href="index.php?page=connexioncoach" style="color:#333;">Accès Espace Pro</a>
            </p>
        </div>
    </div>
</section>
